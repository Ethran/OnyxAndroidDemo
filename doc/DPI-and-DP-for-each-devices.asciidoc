...
sw-dp calculation formula:
After calculating the result of sw*160/dpi, select a dp that is smaller than this result and closest to it.
For example, for 1280 * 960, according to the formula: 960 * 160 / 160 = 960
